      ...
      >
          ...
          >
            ...
            <div className="detalleContainer" >
                <div className="detalleZoom">
                    <ZoomDetail images={images} />
                </div>

                <div className="detalleDescription" >
                ...
                <div className="detalleTres">
                    ...
                    <Box sx={{
                        ...
                        <Box
                            ...
                            <Review id={id} image={product.img} name={product.title} />
                        </Box>
                    </Box>
                </div>

            </div>
            <div className="detalleComment">
                <Box
                    sx={{
                        display: "flex",
                        flexWrap: "wrap",
